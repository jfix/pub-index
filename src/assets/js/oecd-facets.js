$(function () {
    ...
    $(".facet-value, .pubtype-label").click(function (event) {
        /* not sure why this is needed, there is no default action on span elements */
        event.preventDefault();
        /* stop propagaction, otherwise click event bubbles up to search-result-item parent which will display publication page */
