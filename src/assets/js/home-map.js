/*globals $:true, google:true, InfoBox:true, MarkerClusterer:true*/
$(function () {

    $.getJSON('/items-by-country', function (data) { /*var center = new google.maps.LatLng(22.49, 89.76);*/
        ...
        */
        ...
        var mcOptions = {
            gridSize: 30,
            /* modify this to change what's covered by a cluster */
            maxZoom: 15,
        ...
        var markers = $.map(data, function (e, i) {
            var count = e.data.count;
            var country = e.data.country;
            var code = e.data.code;
            var infobox = new InfoBox();

            var label = ((count === 1) ? "There is only one publication on " + country : "There are " + count + " publications on " + country);
            ...
            var marker = new google.maps.Marker({
                ...
                /* position on the map*/
                /*title: label,*/
                /* There are X publications on YY */
